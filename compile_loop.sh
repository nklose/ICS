...
#property of the client, regarded as a copyrighted collection. The framework and
#code base created by the development team is their own intellectual property,
#and may only be used for the purposes outlined in the documentation of the
#application, which has been provided to the client. The development team agrees
#not to use their framework for, or take part in the development of, anything
#that falls within the domain of use for the application, for a period of 6
