...
#
# Created: Sun Mar 31 16:53:11 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.imageGroup.setGeometry(QtCore.QRect(10, 30, 511, 500))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.image = QtGui.QLabel(self.imageGroup)
        self.image.setGeometry(QtCore.QRect(50, 30, 400, 400))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.image.setFont(font)
        self.image.setFrameShape(QtGui.QFrame.Panel)
        self.image.setFrameShadow(QtGui.QFrame.Sunken)
        self.image.setText(_fromUtf8(""))
        self.image.setScaledContents(True)
        self.image.setObjectName(_fromUtf8("image"))
        self.imagePath = QtGui.QLabel(self.imageGroup)
        self.imagePath.setGeometry(QtCore.QRect(10, 450, 491, 41))
        self.imagePath.setFrameShape(QtGui.QFrame.Box)
        self.imagePath.setFrameShadow(QtGui.QFrame.Sunken)
        self.imagePath.setText(_fromUtf8(""))
        ...
        self.imageParametersGroup.setGeometry(QtCore.QRect(530, 30, 481, 231))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.loadButton.setGeometry(QtCore.QRect(100, 30, 261, 31))
        self.loadButton.setObjectName(_fromUtf8("loadButton"))
        self.fileCountLabel = QtGui.QLabel(self.imageParametersGroup)
        self.fileCountLabel.setGeometry(QtCore.QRect(50, 110, 141, 21))
        ...
        self.imageFormatLabel.setGeometry(QtCore.QRect(50, 200, 141, 21))
        ...
        self.fileCount.setGeometry(QtCore.QRect(200, 110, 221, 21))
        ...
        self.formatsList.setGeometry(QtCore.QRect(200, 200, 221, 21))
        ...
        self.rgbCount.setGeometry(QtCore.QRect(200, 140, 221, 21))
        ...
        self.numRgbLabel.setGeometry(QtCore.QRect(50, 140, 141, 21))
        ...
        self.numMonochromeLabel.setGeometry(QtCore.QRect(50, 170, 141, 21))
        ...
        self.monoCount.setGeometry(QtCore.QRect(200, 170, 221, 21))
        ...
        self.folderLabel.setGeometry(QtCore.QRect(20, 70, 421, 31))
        font = QtGui.QFont()
        ...
        self.correlationSettingsGroup.setGeometry(QtCore.QRect(530, 270, 481, 341))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.allTripleParametersGroup.setGeometry(QtCore.QRect(10, 170, 461, 161))
        ...
        self.tripleRangeLabel.setGeometry(QtCore.QRect(150, 60, 51, 31))
        ...
        self.tripleG0Label.setGeometry(QtCore.QRect(150, 100, 51, 31))
        ...
        self.tripleWLabel.setGeometry(QtCore.QRect(320, 60, 21, 31))
        ...
        self.tripleGinfLabel.setGeometry(QtCore.QRect(290, 100, 51, 31))
        ...
        self.tripleRange.setGeometry(QtCore.QRect(210, 60, 91, 31))
        ...
        self.tripleG0.setGeometry(QtCore.QRect(210, 100, 91, 31))
        ...
        self.tripleW.setGeometry(QtCore.QRect(350, 60, 91, 31))
        ...
        self.tripleGinf.setGeometry(QtCore.QRect(350, 100, 91, 31))
        ...
        self.resolution64.setGeometry(QtCore.QRect(20, 130, 91, 22))
        self.resolution64.setObjectName(_fromUtf8("resolution64"))
        self.tripleG0Label_2 = QtGui.QLabel(self.allTripleParametersGroup)
        self.tripleG0Label_2.setGeometry(QtCore.QRect(20, 20, 91, 51))
        self.tripleG0Label_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tripleG0Label_2.setWordWrap(True)
        ...
        self.resolution32.setGeometry(QtCore.QRect(20, 100, 91, 22))
        ...
        self.resolution16.setGeometry(QtCore.QRect(20, 71, 91, 21))
        ...
        self.allAutoCrossGroup.setGeometry(QtCore.QRect(10, 20, 461, 141))
        ...
        self.dualRangeLabel.setGeometry(QtCore.QRect(150, 50, 51, 31))
        ...
        self.dualG0Label.setGeometry(QtCore.QRect(150, 90, 51, 31))
        ...
        self.dualWLabel.setGeometry(QtCore.QRect(320, 50, 21, 31))
        ...
        self.dualGinfLabel.setGeometry(QtCore.QRect(290, 90, 51, 31))
        ...
        self.considerAutoDeltas.setGeometry(QtCore.QRect(20, 70, 151, 21))
        ...
        self.considerCrossDeltas.setGeometry(QtCore.QRect(20, 100, 151, 20))
        ...
        self.dualRange.setGeometry(QtCore.QRect(210, 50, 91, 31))
        ...
        self.dualG0.setGeometry(QtCore.QRect(210, 90, 91, 31))
        ...
        self.dualW.setGeometry(QtCore.QRect(350, 50, 91, 31))
        ...
        self.dualGinf.setGeometry(QtCore.QRect(350, 90, 91, 31))
        ...
        self.tripleG0Label_3 = QtGui.QLabel(self.allAutoCrossGroup)
        self.tripleG0Label_3.setGeometry(QtCore.QRect(20, 20, 91, 51))
        self.tripleG0Label_3.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tripleG0Label_3.setWordWrap(True)
        self.tripleG0Label_3.setObjectName(_fromUtf8("tripleG0Label_3"))
        self.messageBox = QtGui.QLabel(Dialog)
        self.messageBox.setGeometry(QtCore.QRect(10, 540, 511, 71))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.allAutoCrossGroup.setTitle(_translate("Dialog", "Auto/Cross-Correlation Parameters", None))
        ...
        self.considerAutoDeltas.setText(_translate("Dialog", "Auto", None))
        self.considerCrossDeltas.setText(_translate("Dialog", "Cross", None))
        self.tripleG0Label_3.setText(_translate("Dialog", "Consider Deltas:", None))
